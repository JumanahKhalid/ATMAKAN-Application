...
public class ShadowAnimals_L1_1 extends AppCompatActivity {
    ImageButton giraffeimage, dolfenimage, tigerimage, sharkimage;
    ImageView home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shadow_animals_l11);
        mp = MediaPlayer.create(ShadowAnimals_L1_1.this, R.raw.wrong);
        Animals = MediaPlayer.create(ShadowAnimals_L1_1.this, R.raw.shadowanimalsv);
        Animals.start();
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new
                        Intent(ShadowAnimals_L1_1.this, Entertainment.class);
                Animals.pause();
        ...
        dolfenimage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mp = MediaPlayer.create(ShadowAnimals_L1_1.this, R.raw.correct1);
                mp.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                    @Override
                    public void onPrepared(MediaPlayer mediaPlayer) {
                        Animals.pause();
                ...
                mp.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    ...
                    public void onCompletion(MediaPlayer mediaPlayer) {
                        mp.release();
                        Intent intent = new
                                Intent(ShadowAnimals_L1_1.this, ShadowAnimals_L1_2.class);
                        startActivity(intent);
                    }
                });
            }
